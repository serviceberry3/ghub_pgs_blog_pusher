...
public final class RepoContract {
    ...
    //represents an entry in sqlite3 table
    public static abstract class RepoEntry implements BaseColumns {
        //arbitrary name for our sqlite3 table
    ...
    public static String getUsername(Cursor cursor) {
        Log.i(TAG, "index 3  is " + cursor.getString(3));
        Log.i(TAG, "username col is  index " + cursor.getColumnIndex("username"));
